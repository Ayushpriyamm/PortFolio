...
const HeroSection = () => {
  return (
    <motion.div className="py-20 bg-gradient-to-r from-[#2a181a] via-[#42211e] via-[#411d1f] via-[#41291a] via-[#493d14] via[#213839] to-[#213e46]  flex flex-col md:flex md:flex-row mx-auto justify-between  items-center p-6 md:py-20  ">
      <motion.div
        id="Home"
        className="flex flex-col text-center md:text-left md:w-[850px]"
      >
        <motion.h1 className="text-yellow-500 text-5xl md:text-7xl font-bold md:font-extrabold py-4">
          Hello,
        </motion.h1>

        <h1 className="text-white text-5xl md:text-7xl font-bold md:font-extrabold py-4">
          I am Ayush
        </h1>
        <h1 className="text-green-500 text-3xl md:text-4xl font-bold py-4">
          Web Developer
        </h1>
        <p className="text-white   py-2">
          Welcome to my creative playground, where innovation meets imagination,
          and I'm Ayush, your friendly neighborhood digital alchemist. I've made
          it my mission to turn boring ideas into web wizardry that even Harry
          Potter would find spellbinding!
        </p>
      ...
      <motion.div className="flex justify-center items-center md:w-450">
