    ...
    <div className="  relative flex flex-row p-6 mx-auto md:flex md:flex-row md:justify-between md:items-center justify-between items-center">
      <div className="md:hidden  ">
        <button onClick={toggleMenu} className="rounded-[50%] p-1 bg-green-500">
          ...
          <motion.div
            ...
            className={`absolute px-5 top-0 rounded-lg  left-0 bg-white  h-screen text-white flex flex-col space-y-2 z-40 ${
          ...
          >
            ...
            <div className="flex flex-col py-[50%] space-y-6 text-white">
              ...
              <div className="w-full bg-green-500 hover:green-700 border-2 border-yellow-500 p-2 rounded-lg">
                <a
                  href="#Advantages"
                  className="text-2xl p-6 items-center font-bold"
                >
                  About
                </a>
              </div>
      ...
      <div className="flex flex-row ">
        <a href="/" className="flex flex-row  items-center space-x-4">
          ...
          <h2 className="text-white text-2xl md:text-3xl font-bold md:font-extrabold">
            {" "}
            Ayush
          </h2>
        </a>
      ...
      <div className="md:flex flex flex-row space-x-6 font-semibold text-white ">
        <div className="hidden md:block text-xl">
          <a
            href="/"
            className="border-b-4 border-green-500 hover:rounded hover "
          >
            Home
          </a>
        </div>
        <div className="hidden md:block text-xl">
          <a
            href="#Advantages"
            className="border-b-4 border-transparent hover:border-b-4 hover:rounded hover:border-green-500"
          >
            About
          </a>
        </div>
      ...
      <div className="hidden md:block text-white">
        <ButtonGreen
          ButtonName="Resume"
          href="https://drive.google.com/file/d/1cDl2CagBuDFPZTWMSD6m4lmJet_t0B3C/view?usp=sharing"
          target="_blank"
        ></ButtonGreen>
      </div>
